...
namespace Broker.UnitTests
{
    ...
    public class BrokerMessageTests : AssertionHelper
    {
        ...
        {
            Expect(new BrokerMessage("type", null, Guid.Empty, Guid.Empty).Message, EqualTo(string.Empty));
        }

        [Test]
        public void Constructor_MessageTypeAsNull_MessageTypeSetToEmptyString()
        {
            Expect(new BrokerMessage(null, "Message", Guid.Empty, Guid.Empty).MessageType, EqualTo(string.Empty));
        }
        ...
        {
            Expect(BrokerMessage.Empty != new BrokerMessage("type", "", Guid.Empty, Guid.Empty), Is.True);
        }
    }
}
